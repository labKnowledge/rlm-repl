...
def main():
    ...
    with DocumentQA() as qa:
        ...
        Software architecture patterns are reusable solutions to common problems
        in software design. They provide a template for organizing code and
        managing complexity in large applications.

        ## Layered Architecture

        The layered architecture pattern organizes code into horizontal layers:
        - Presentation Layer: User interface
        - Business Layer: Business logic
        - Persistence Layer: Data storage
        - Database Layer: Database operations
        ...
        DDD focuses on the business domain:
        ...
        print("\n1. Loading document...")
        stats = qa.load_content(content, "architecture_patterns")
        print(f"   Loaded: {stats['lines']} lines, {stats['words']} words")
